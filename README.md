...
| 2 | What everyday tasks does a data scientist perform?| Finding patterns in data, building models, forecasting outcomes, using machine learning, and communicating insights.|A data scientist performs tasks such as: 
